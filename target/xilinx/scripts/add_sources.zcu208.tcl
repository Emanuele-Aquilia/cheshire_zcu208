...
add_files -norecurse -fileset [current_fileset] [list \
    $ROOT/target/xilinx/src/dmi_bscane_tap.sv \
]
...
add_files -norecurse -fileset [current_fileset] [list \
    ...
    $ROOT/target/xilinx/src/regs/chs_xilinx_reg_pkg.sv \
    $ROOT/target/xilinx/src/regs/chs_xilinx_reg_top.sv \
    $ROOT/target/xilinx/src/cheshire_top_xilinx.sv \
]

set_property include_dirs [list \
    $ROOT/.bender/git/checkouts/apb-d506f9cfdae5c46b/include \
    ...
    $ROOT/.bender/git/checkouts/obi-7e44f4165b1b0649/include \
